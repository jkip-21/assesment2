...
<body>
    ...
    <div class="grid1">
        <div class="recipe-sec">
            <a href="./displays/display.php"><img src="<?php echo $recip->image; ?>" alt="Image should be here"
                    height="100px" width="100px"></a>
            <p><?php echo $recip->title; ?></p>
        </div>
        <div class="recipe-sec1">
            <a href="./displays/display2.php"><img src="<?php echo $recipe1->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe1->title ?></p>
        </div>
        <div class="recipe-sec2">
            <a href="./displays/display3.php"><img src="<?php echo $recipe2->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe2->title ?></p>
        </div>
        <div class="recipe-sec3">
            <a href="./displays/display4.php"><img src="<?php echo $recipe3->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe3->title ?></p>
        </div>
        <div class="recipe-sec4">
            <a href="./displays/display5.php"> <img src="<?php echo $recipe4->image?>" alt="" height="100px"
                    width="100px"></a>
    ...
    <div class="grid2">
        <div class="recipe-sec5">
            <a href="./displays/display6.php"><img src="<?php echo $recipe5->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe5->title ?></p>
        </div>
        <div class="recipe-sec6">
            <a href="./displays/display7.php"><img src="<?php echo $recipe6->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe6->title ?></p>
        </div>
        <div class="recipe-sec6">
            <a href="./displays/display8.php"><img src="<?php echo $recipe7->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe7->title ?></p>
        </div>
        <div class="recipe-sec8">
            <a href="./displays/display9.php"><img src="<?php echo $recipe8->image?>" alt="" height="100px"
                    width="100px"></a>
            <p><?php echo $recipe8->title ?></p>
        </div>
        <div class="recipe-sec9">
            <a href="./displays/display10.php"><img src="<?php echo $recipe9->image?>" alt="" height="100px"
                    width="100px"></a>
    ...
    //             }
    //             if (x == "Ginger Beef" || x == 'Ginger' || x == 'ginger' || x == 'gin' || x == 'beef' || x ==
    //                 'GINGER' ||
    //                 x == 'GINGER BEEF' || x ==
    //                 'BEEF') {
    ...
    <script>
    // A study of the code using Switch Control 
